...
const gabiskiria = () => {
  return (
    ...
    <div class="pg-bio-container">
        <h1 class="pg-person-name">Guram Gabiskiria (1947 - 1993)</h1>
        <div class="pg-person-bio">
            ...
            <div class="pg-person-story">
                {/* <h3 class="pg-name-date">Guram Gabiskiria (1947 - 1993)</h3>
                <h3 class="pg-profession">Former Mayor of Sukhumi</h3> */}

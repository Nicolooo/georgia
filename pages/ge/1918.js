...
const Meore = () => {
    ...
    return (
        <>
        <Title title="Georgian Liberty I დამოუკიდებლობის დღე" meta="დამოუკიდებლობის დღე 1917 წლის თებერვლის რევოლუციის შემდეგ რუსეთის მართვა თავის თავზე დროებითმა მთავრობამ იკისრა. დროებითი მთავრობის გადაწყვეტილებით ამიერკავკასიის მართვა დაევალა ამიერკავკასიის განსაკუთრებულ კომიტეტს - ოზაკომს. თუმცა ოზაკომმა უფლებამოსილება დაკარგა მას შემდეგ, რაც 1917 წლის ოქტომბერში რუსეთში ბოლშევიკური რევოლუცია მოხდა და დროებითი მთავრობა დაემხო." />
        <Menu LANG="Ge"/>
        ...
        <div className="abkhazia-wrapper container">
            <div className="abkhazia-title row"> 
                <div className="april-header">
                    <h1 className="april-main-title">დამოუკიდებლობის მოპოვება</h1>
                    <h3 className="april-main-sub">26 მაისი, 1918</h3>
                </div>
            ...
            <Next options={linkz} />
            <Share url="/ge/1918" title="გააზიარეთ" cite1="ციტირება" cite2="1918.” ჯორჯიან ლიბერთი | 1918, September 27, 2021.  https://www.georgianliberty.com/ge/1918,           '"/>
        </div>
        </>
    )
}

        ...
        <div className="abkhazia-wrapper container">
            <div className="abkhazia-title row"> 
                <div className="april-header">
                    <h1 className="april-main-title">წითელი არმიის შემოსვლა</h1>
            ...
            <Next options={linkz} />
            <Share url="/ge/1921" title="გააზიარეთ" cite1="ციტირება" cite2="1921.” ჯორჯიან ლიბერთი | 1921, September 27, 2021.  https://www.georgianliberty.com/ge/1921,           '"/>
        </div>
        </>
    )
}
